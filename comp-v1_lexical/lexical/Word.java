...
public class Word extends Token {
    ...
    public final static Word int = new Word("int", Tag.INT);
    public final static Word float = new Word("float", Tag.FLOAT);
    public final static Word string = new Word("string", Tag.STRING);
    public final static Word if = new Word("if", Tag.IF);
    public final static Word then = new Word("then", Tag.THEN);
    public final static Word else = new Word("else", Tag.ELSE);
    public final static Word end = new Word("end", Tag.END);
    public final static Word do = new Word("do", Tag.DO);
    public final static Word while = new Word("while", Tag.WHILE);
    ...
    public final static Word greater_than = new Word(">=", Tag.GREATER_THAN);
    public final static Word less = new Word("<", Tag.LESS);
    public final static Word less_than = new Word("<=", Tag.LESS_THAN);
